...
class PortfolioReporter:
    ...
    def get_portfolio_holdings(self):
        """Fetch current portfolio holdings from Kite API"""
        try:
            ...
            logger.info(f"Successfully fetched {len(holdings.get('data', []))} holdings")
    ...
    def generate_email_content(self, analysis):
        ...
        html_content += """
            ...
            <div class="section">
                <p><em>This report was generated automatically by Portfolio Reporter.</em></p>
            </div>
        </body>
        </html>
        """
